...
<li>Prior to hire, Crossover Health Human Resources (HR) engages a third-party service for background checks. [See Screening Policy, 02.b.] </li>
<li>New employees are required to sign an agreement to comply with all security and privacy policies. v
<li>When a new employee joins the workforce, HR notifies department heads via HRIS electronic notification. The hiring manager submits an electronic request to IT for access to technical devices and applications. </li>
<li>When a request for new user is received by IT, the assigned IT staff member will verify the request is in accordance with established user roles. [See Policies 01.a., 01.b.]</li>
<li>The Security Officer will review all roles yearly for current and appropriate security access. </li>
